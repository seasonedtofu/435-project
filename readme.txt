...
TO CREATE TABLES IN MYSQL, USE CSV FILES IN THE 'csv_files' folder.
QUERIES TO CREATE TABLES ARE LOCATED IN 'create_tables_queries.txt'.
...
RUN CLI IN TERMINAL with 'python 435cli.py'.
